    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frequency', models.CharField(choices=[('day', 'день'), ('week', 'неделя'), ('month', 'месяц')], default='day', max_length=30, verbose_name='периодичность')),
                ...
                ('message', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mail.message', verbose_name='сообщение')),
            ],
            options={
